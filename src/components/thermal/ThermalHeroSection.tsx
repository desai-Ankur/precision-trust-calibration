...
import { ArrowRight, Thermometer, Shield, Award, Flame } from "lucide-react";
import { Link } from "react-router-dom";

export const ThermalHeroSection = () => {
  ...
  return (
    <section ref={sectionRef} className="relative min-h-[90vh] flex items-center pt-20 overflow-hidden bg-gradient-hero">
      <motion.div className="absolute inset-0 overflow-hidden pointer-events-none" style={{ y: bgY }}>
        {/* Heat gradient orbs */}
        <motion.div
          className="absolute top-1/4 right-0 w-[700px] h-[700px] bg-destructive/8 rounded-full blur-3xl"
        ...
        />
        <motion.div
          className="absolute top-1/2 left-1/3 w-[300px] h-[300px] bg-destructive/5 rounded-full blur-3xl"
        ...
        <svg className="absolute inset-0 w-full h-full opacity-[0.03]" xmlns="http://www.w3.org/2000/svg">
          <defs>
            <pattern id="thermalgrid" width="60" height="60" patternUnits="userSpaceOnUse">
        ...
        <svg className="absolute inset-0 w-full h-full opacity-10" viewBox="0 0 1200 800" preserveAspectRatio="none">
          <motion.path
            d="M0,400 Q150,370 300,400 T600,400 T900,400 T1200,380"
            fill="none"
            stroke="hsl(0 72% 51%)"
            strokeWidth="2"
          ...
          />
          <motion.path
            d="M0,420 Q200,390 400,430 T800,410 T1200,420"
            fill="none"
            stroke="hsl(25 95% 53%)"
            strokeWidth="1.5"
            initial={{ pathLength: 0, opacity: 0 }}
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <span className="text-sm font-medium text-destructive">Thermal Department</span>
          </motion.div>
          ...
          >
            ISO/IEC 17025:2017 accredited laboratory delivering high-accuracy temperature measurement
            calibration — from RTD sensors and thermocouples to environmental chambers and validation systems.
          </motion.p>
          ...
          >
            {[
              { icon: Thermometer, text: "14+ Instrument Types" },
