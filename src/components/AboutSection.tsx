        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center" ref={ref}>
          ...
          >
            ...
            <div className="grid grid-cols-2 gap-4">
              <motion.div
                className="rounded-xl overflow-hidden shadow-card border border-border/30"
                whileHover={{ scale: 1.03 }}
                transition={{ duration: 0.3 }}
              >
                <img src={labInstruments} alt="Lab instruments" className="w-full h-40 object-cover" loading="lazy" />
              </motion.div>
              <motion.div
                className="rounded-xl overflow-hidden shadow-card border border-border/30"
                whileHover={{ scale: 1.03 }}
                transition={{ duration: 0.3 }}
              >
                <img src={labFluidFlow} alt="Fluid flow setup" className="w-full h-40 object-cover" loading="lazy" />
              </motion.div>
            </div>
