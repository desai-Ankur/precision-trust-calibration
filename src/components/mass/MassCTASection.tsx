...
import { Scale, ArrowRight, Mail, Phone } from "lucide-react";
import { Link } from "react-router-dom";

export const MassCTASection = () => {
    ...
    <section className="py-24 relative overflow-hidden" ref={ref}>
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            Ensure precise measurements and compliance with IQCL's expert calibration services.
          </motion.p>
          ...
          >
            Get in touch with our expert metrology team for fast, accurate, and traceable
            mass and volumetric calibration.
          </motion.p>
          ...
          >
            <a href="tel:+919824040548" className="flex items-center gap-2 hover:text-primary transition-colors">
              <Phone className="w-4 h-4" />
              <span>+91 98240 40548</span>
            </a>
            <a href="mailto:iccahmedabad@gmail.com" className="flex items-center gap-2 hover:text-primary transition-colors">
