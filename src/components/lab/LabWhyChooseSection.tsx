...
const reasons = [
  ...
  { icon: Target, title: "Wide Measurement Range", description: "Calibration capabilities covering temperature, pH, conductivity, RPM, and more." },
  { icon: Users, title: "Expert Metrologists", description: "Skilled calibration engineers with deep expertise in laboratory instrumentation." },
  { icon: Clock, title: "Fast Turnaround", description: "Efficient calibration workflows to minimize your instrument downtime." },
  { icon: Shield, title: "Industry Compliance", description: "Full compliance with pharmaceutical, environmental, and industrial quality regulations." },
  { icon: Headphones, title: "Dedicated Support", description: "Ongoing technical support and consultation for all your lab calibration needs." },
];

export const LabWhyChooseSection = () => {
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        >
          ...
          <h2 className="font-display text-3xl sm:text-4xl font-bold text-foreground mb-4">
            Why IQCL for{" "}
            <span className="text-gradient">Lab Calibration</span>
          </h2>
          <p className="text-muted-foreground text-lg">
            Industry-leading accuracy, certified processes, and expert support for all your
            laboratory instrument calibration requirements.
          </p>
        </motion.div>
